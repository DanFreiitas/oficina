...
public class EditarFuncionario extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jTextField5.setForeground(new java.awt.Color(58, 167, 220));

        jLabel6.setForeground(new java.awt.Color(58, 167, 220));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        this.matricula = this.jTextField5.getText();
        this.idfuncionario = this.jTextField3.getText();
        
        f1.setNome(nome);
        f1.setCpf(cpf);
        f1.setMatricula(matricula);
        f1.setIdfuncionario(idfuncionario);
        ...
        System.out.println("Funcionario editado!");        // TODO add your handling code here:
